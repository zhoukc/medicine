package com.example.medicine.model.framework.llpay.config;
...
public interface PartnerConfig {
    ...
    // 接收异步通知地址
    String NOTIFY_URL = "http://127.0.0.1:8080/api/pay/llPayNotify";
    // 支付结束后返回地址 同步通知
    String URL_RETURN = "http://127.0.0.1:8080/urlReturn.jsp";
    // 商户编号
